...
/**
 *      \file       brasserie/biere_script.php
 *		\ingroup    brasserie
...
// Examples for manipulating class biere_class
require_once(DOL_DOCUMENT_ROOT."/../brasserie/biere.class.php");
$myobject=new Biere($db);
