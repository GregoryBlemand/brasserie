...
// Examples for manipulating class brasserie_class
require_once(DOL_DOCUMENT_ROOT."/../brasserie/brasserie.class.php");
$myobject=new Brasserie($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."brasserie";
