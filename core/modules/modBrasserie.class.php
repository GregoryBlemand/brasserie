...
/**
 * \defgroup    brasserie    brasserie module
 * \brief       brasserie module descriptor.
 *
 * Module de gestion de brasserie liées à un tiers et vendant des bières
 */

/**
 * \file        core/modules/modBrasserie.class.php
 * \ingroup     brasserie
...
//        )
	...
	public $name = "Brasserie";

	/** @var string Module short description */
	public $description = "module de gestion de brasseries";

	/** @var string Module long description */
	public $descriptionlong = "Module de gestion de brasserie liées à un tiers et vendant des bières";
	...
	public $const_name = 'MAIN_MODULE_brasserie';

	/**
	 * @var string Module logo
	 * Should be named object_brasserie.png and store under brasserie/img
	 */
	public $picto = 'brasserie@brasserie';

	/** @var array Define module parts */
	public $module_parts = array(
		/** @var bool Module ships triggers in brasserie/core/triggers */
		'triggers' => false,
		/**
		 * @var bool Module ships login in brasserie/core/login
		 * @todo: example
		 */
		'login' => false,
		/**
		...
		'menus' => false,
		/**
		 * @var bool Module ships theme in brasserie/theme
		 * @todo example
		 */
		'theme' => false,
		/**
		 * @var bool Module shipped templates in brasserie/core/tpl overload core ones
		 * @todo example
		 */
		'tpl' => false,
		/**
	...
	public $config_page_url = 'setup.php@brasserie';
	...
	public function __construct($db)
	{
		...
		//$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@brasserie:$user->rights->brasserie->read:/brasserie/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@brasserie:$user->rights->othermodule->read:/brasserie/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->brasserie->enabled)) {
		...
		//	// Use '$conf->brasserie->enabled' if entry must be visible if module is enabled.
		//	'enabled'=>'$conf->brasserie->enabled',
		//	// Use 'perms'=>'$user->rights->brasserie->level1->level2'
	 ...
	 * and create data commands must be stored in directory /brasserie/sql/
	...
	{
		return $this->_load_tables('/brasserie/sql/');
	}
